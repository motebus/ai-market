...
For the purposes of this tutorial, select `1 GPU, 4 cores, 90 GB memory`.
...
Simply change the last component of the url address `/tree` to `lab`. 
...
If you wish to create a new CKAN API key, 
